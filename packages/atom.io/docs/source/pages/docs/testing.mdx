	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td>
					A snapshot object with <code>store</code> and <code>restore()</code>.
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					Check whether a state exists in the implicit store without creating it.
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					Check whether a state exists in a specific store without creating it.
				</td>
			</tr>
			<tr>
				<td>
