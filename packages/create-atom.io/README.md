...
| `preact-realtime-vector-editor` | A canonical Preact vector editor with Mosaic Domain batching, presence, and actor-safe history. |
...
| Option             | Alias | Values                                                                                                                             |
| :----------------- | :---- | :--------------------------------------------------------------------------------------------------------------------------------- |
| `--templateName`   | `-t`  | `preact-realtime-vector-editor`, `preact-svg-editor`, `react-node-backend`, `react-realtime-text-editor`, `solid-lossless-numbers` |
