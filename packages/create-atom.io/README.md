...
| `react-realtime-markdown` | A multiplayer React Markdown editor with presence and selective per-user undo.              |
...
| Option             | Alias | Values                                                                                         |
| :----------------- | :---- | :--------------------------------------------------------------------------------------------- |
| `--templateName`   | `-t`  | `preact-svg-editor`, `react-node-backend`, `react-realtime-markdown`, `solid-lossless-numbers` |
