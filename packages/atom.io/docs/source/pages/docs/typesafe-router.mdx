...
{/* DOCS REVIEW: TreeTrunks is doing a lot of work here but is not introduced or linked. Should this mention the package, install/import expectation, and why atom.io docs recommend it for this pattern? */}
