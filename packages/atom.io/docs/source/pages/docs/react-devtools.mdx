...
<Exhibit src="tooling/react-devtools/basic-setup.tsx.txt" />
...
<Exhibit src="tooling/react-devtools/hide-by-default.tsx.txt" />
...
- [Layout.astro](/Users/jem/dojo/atom.io/apps/atom.io.fyi/src/layouts/Layout.astro)

{/* DOCS REVIEW: This absolute local path probably will not work for readers or generated agent docs. Should this be repo-relative or removed from the published page? */}
