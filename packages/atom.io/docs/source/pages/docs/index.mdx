  ...
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td>
          Read or edit <code>join</code> relations with <code>find</code>,
          <code>internal</code>, and <code>edit</code>.
          {/* DOCS REVIEW: `internal` and `edit` appear here without nearby examples. Would a short link/example prevent readers from treating this as opaque transaction-only magic? */}
        </td>
      </tr>
    </tbody>
  </table>
...
{/* DOCS REVIEW: "Above" depends on the exhibit rendering and is especially vague in the generated agent docs. Should we name the update shape or describe the important fields here? */}
...
{/* DOCS REVIEW: "value map" sounds internal. Could this explain what user code observes while pending, after resolve, and during a newer pending refresh? */}
