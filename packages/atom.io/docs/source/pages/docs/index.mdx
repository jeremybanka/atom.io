...
{/* DOCS REVIEW: This is memorable, but maybe too absolute. Should we name the tradeoff: smaller atoms improve observation granularity, but indexes/coordination still need deliberate modeling? */}
