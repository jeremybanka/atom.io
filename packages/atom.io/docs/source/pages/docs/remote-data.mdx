...
{/* DOCS REVIEW: The example keys an atom family with a tuple view. Should this call out what makes a tuple key stable/canonical in atom.io, and whether object-shaped view keys would be unsafe or merely less ideal? */}
