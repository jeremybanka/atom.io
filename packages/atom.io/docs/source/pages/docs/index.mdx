    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          {/* DOCS REVIEW: This is hard to parse as written ("produce in"). Should this also distinguish direct atom writes from writable selector writes more explicitly? */}
        </td>
      </tr>
      <tr>
        <td>
  ...
  <table>
    <tbody>
      <tr>
        ...
        <td>Read an atom, selector, or family member in the transaction.</td>
      </tr>
      <tr>
        <td>
          <code>set</code>
        </td>
        <td>Write a writable atom, selector, or family member.</td>
      </tr>
      <tr>
        <td>
          <code>reset</code>
